...
export const BOTTLE_TYPES = [
  ...
  { type: 'tequila', color: '#FFD700', liquidColor: '#FFFFFF', points: 40, hits: 1, scale: 0.7 }, // Fragile/Small
  { type: 'jug', color: '#4E3629', liquidColor: '#FFFFFF', points: 50, hits: 2, scale: 1.3 }, // Heavier
] as const;
